...
int FF_QUIT_EVENT = SDL_QUIT + 1;
int FF_ALLOC_EVENT = SDL_QUIT + 2;
int FF_REFRESH_EVENT = SDL_QUIT + 3;
...
int main(int argc, char *argv[])
{
    ...
    is->screen = SDL_SetVideoMode(pCodecCtx->width, pCodecCtx->height, 0, 0);
    if (!is->screen)
    {
